		...
		<footer
			...
			<div className='mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32'>
				<div className='xl:grid xl:grid-cols-3 xl:gap-8'>
					<div className='space-y-8'>
						<p className='text-sm leading-6 text-gray-600'>
							Todos los proyectos son realizados en typescript y estan en servidores externos gratuitos por ello pueden
							demorar al cargar.
						</p>
						<div className='flex space-x-6'>
							...
							<Link
								to='https://github.com/JavierSantoyo89'
								className='text-gray-400 hover:text-gray-500'>
				...
				<div className='mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 lg:mt-24'>
					<p className='text-xs justify-center text-center leading-5 text-gray-500'>
						&copy; 2024 todos los derechos reservados a sus respectivos dueños.
					</p>
				</div>
			</div>
		</footer>
